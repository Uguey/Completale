...
/**
 * The primary key class for the wrap database table.
 * 
 */
@Embeddable
@Table(uniqueConstraints=
		@UniqueConstraint(columnNames = {"leaderStory", "openDateStory"}))
public class WrapPK implements Serializable {
	...
	public WrapPK(String leaderStory, Date openDateStory) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof WrapPK)) {
			return false;
		}
		WrapPK castOther = (WrapPK)other;
		return 
