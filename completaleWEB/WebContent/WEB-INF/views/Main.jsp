						      		...
						      		<form class="form-horizontal" role="form" action="/completaleWEB/ParticipateInChallenge" id="formTimelineChallenge" autocomplete="off">
							      		<div class="modal-body">
							      			<div class="form-group">
										    	<label class="control-label col-xs-2" for="titleStory"><span class="adjustLabel">Título:</span></label>
											    <div class="col-xs-10">
											...
											<div id="adjustElementsInside">
										    	<p id="divNames"></p>
										    	<button class="btn btn-sm btn-success" id="addUser">Añadir usuario</button>
										    </div>
						...
						<div class="modal-dialog">
					    	<div class="modal-content">
					      		...
					      		<form class="form-horizontal" role="form" action="/completaleWEB/CreateStory" id="formStories" autocomplete="off">
						      		<div class="modal-body">
						      			<div class="form-group">
									    	<label class="control-label col-xs-2" for="titleStoryTwo"><span class="adjustLabel">Título:</span></label>
										    <div class="col-xs-10">
										...
										<div id="adjustElementsInsideTwo">
									    	<p id="divNamesTwo"></p>
									    	<button class="btn btn-sm btn-success" id="addUserTwo">Añadir usuario</button>
									    </div>
						      		</div>
						      		<div class="modal-footer">
						...
						<div class="modal-dialog">
					    	<div class="modal-content">
					      		...
					      		<form class="form-horizontal" role="form" action="/completaleWEB/CreateChallenge" method="post">
						      		<div class="modal-body">
						      			<div class="form-group">
									    	<label class="control-label col-xs-2" for="titleChallenge"><span class="adjustLabel">Título:</span></label>
										    <div class="col-xs-10">
										      	<input type="text" class="form-control" id="titleChallenge" name="titleChallenge">
										    </div>
									  	</div>
									  	<div class="form-group">
									    	<label class="control-label col-xs-2" for="descriptionChallenge"><span class="adjustLabel">Descripción:</span></label>
									  	...
									  	<div class="form-group">
									    	<label class="control-label col-xs-9" for="maxStoriesChallenge"><span class="adjustLabel">Máximo número de historias en tu reto:</span></label>
										    <div class="col-xs-3">
									  	...
									  	<div class="form-group">
									    	<label class="control-label col-xs-9" for="endDateChallenge"><span class="adjustLabel">Duración del reto:</span></label>
										    <div class="col-xs-3">
										      	<select class="form-control" id="endDateChallenge" name="endDateChallenge">
												    ...
												    <option value="3">Tres días</option>
												    <option value="4">Cuatro días</option>
												    <option value="5">Cinco días</option>
											  	</select>
										    </div>
									  	</div>
						      		</div>
