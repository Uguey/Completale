...
<!-- Owner -->
<link rel="stylesheet" href="css/MainChallengesParticipantCSS.css">
<script src="js/MainChallengesParticipantJS.js" defer="true"></script>
</head>
<body>	
							...
							<nav class="navbar navbar-inverse adjustNavBar">
							  	<div class="container">
							  		<div class="row">
									    <div class="col-xs-12">
									  		<div class="navbar-header">
										      	<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbarChallenge">
											        <span class="icon-bar"></span>
											        <span class="icon-bar"></span>
											        <span class="icon-bar"></span>  
									        	</button>     
										    </div>
							    			<div class="collapse navbar-collapse" id="navbarChallenge">
										      	<ul class="nav navbar-nav inline">
										        	<li class="active thirdLi" id="LiChallengeOne">
										        		<a id="AChallengeOne" href="#Challenge">Reto &nbsp<span class="badge" id="badgeSum">0</span></a>
										        	</li>
										        	<li class="thirdLi" id="LiChallengeTwo">
										        		<a id="AChallengeTwo" href="#MyStory">Tu historia</a>
										        	</li>
										      	</ul>
										    </div>
										</div>
						...
						<div class="container" id="Challenge">
					  		<div class="jumbotron" id="secondJumbotron">
						    	...
						    	<div class="alert alert-success adjustTimeline" id="storiesTimeline">
									<div class="sameRow">
										<a href="/completaleWEB/SeeStory?access=participant&title=<c:out value="${element}"></c:out>" class="titleHref">									
						...
						<div class="container" id="Story">
							<div class="col-xs-12">
								...
								<div class="page-header" id="adjustTitleStory">
									<p id="adjustTitleStoryProperTitle"><c:out value="${titleStory }"></c:out></p>
								</div>
								<div id="text">	
