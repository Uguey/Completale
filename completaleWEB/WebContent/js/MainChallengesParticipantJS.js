$(document).ready(function(){
	...
	$("#AChallengeOne").click(function(){activeThirdlyClass(0)});
	$("#AChallengeTwo").click(function(){activeThirdlyClass(1)});
	...
	var update = window.setInterval(updateChallenge, 1000);
});
	...
	var activeThirdlyClass = function(x){
		switch (x){
			case 0:
				$("#LiChallengeOne").addClass("active");
				$("#LiChallengeTwo").removeClass("active");
				$("#Story").slideUp(400);
				$("#Challenge").slideDown(400);
				break;
			case 1:
				$("#LiChallengeOne").removeClass("active");
				$("#LiChallengeTwo").addClass("active");
				$("#Challenge").slideUp(400);
				$("#Story").slideDown(400);
				break;
			default:
				console.log("Algo ha ido mal");
	...
	function updateChallenge () {
		$.get("/completaleWEB/UpdateChallengeParticipant?t="+Math.random(),function(data,status){
			if (status=="success"){
				var newData=JSON.parse(data);
			...
			else console.log("Error al obtener los datos del reto mediante AJAX");
		});
	}
